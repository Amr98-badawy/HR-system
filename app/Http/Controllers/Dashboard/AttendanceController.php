...
class AttendanceController extends Controller
{
    ...
    public function companyAttendance(Request $request, Company $company)
    {
        abort_if(!auth()->user()->can('access_attendance'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        if ($request->ajax()) {
            $query = Attendance::with('employee', 'employee.department', 'employee.section')
        ...
        return view('dashboard.attendance.company-index', compact('company'));
    }
